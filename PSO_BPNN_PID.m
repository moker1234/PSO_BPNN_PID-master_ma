...
% ykk=yout'*100;
% ukk=u';
% file_name='D:\Program Files\Polyspace\R2016aWorkplace\PSO_BPNN_PID-master_rare\Res_ParaMat.xlsx';  % 需要保存的文件名称及路径
% xlswrite(file_name,ukk,'sheet1','A1') % B2 表示写入excel中第一个数的位置
